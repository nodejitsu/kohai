...
// TODO: require supporting libs here, like channels.js
var Channel = require('./irc/channel').Channel;
...
exports.attach = function (options) {
  ...
  hook.on('hook::ready', function () {
    ...
    // TODO: use `self.config.get` instead.
    self.config.get('irc:channels').forEach(function (channel) {
  ...
  // TODO: Is this emitted by the irc hook? Or is this from somewhere else?
