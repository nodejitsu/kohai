...
kohai.getPlugins = function () {
  fs.readdirSync(__dirname + '/../lib/plugins').forEach(function (plugin) {
    plugin = plugin.replace('.js', '');
    kohai.plugins.__defineGetter__(plugin, function () {
      return require(__dirname + '/../lib/plugins/' + plugin);
    });
  });
