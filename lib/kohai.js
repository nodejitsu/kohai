...
kohai.start = function (config) {
  ...
  console.log('info: connecting to '.green+(config.server.green||'irc.freenode.net'.green)+'. this will take a few moments and you might see an error message related to the cookies library.'.green);
